...
#    else:
    ...
    sgd = SGD(lr=0.25e-5, decay=1e-6, momentum=0.9, nesterov=True)
#    sgd = SGD(lr=1.25e-05, decay=1e-6, momentum=0.9, nesterov=True)
#    sgd = SGD(lr=6.25e-06, decay=1e-6, momentum=0.9, nesterov=True)
